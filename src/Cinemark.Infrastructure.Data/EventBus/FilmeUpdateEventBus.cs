...
{
    public class FilmeUpdateEventBus : IFilmeUpdateEventBus, IDisposable
    {
        private const string _queueName = "Filme_Update";
        ...
        public FilmeUpdateEventBus(ConnectionEventBus connectionEventBus,
