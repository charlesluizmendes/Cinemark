...
namespace Cinemark.Infrastructure.Data.EventBus
{
    public class CreateFilmeReceive : BackgroundService
    {
        ...
        public CreateFilmeReceive(MongoContext mongoContext,
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(_queueName + EventBusConstants.QUEUE_CREATED, false, consumer);
        ...
        {
            _mongoCollection.InsertOneAsync(filme);
        }
